...
- Top-level sections: `ai/`, `application/`, `command/`, `development/`, `docker/`, `file/`, `git/`, `operation-and-maintenance/`, `software/`.
...
- `command/27.md` and `operation-and-maintenance/redis.md` were missing but are now created; the unused number gaps `command/25.md`, `command/31.md`, `command/32.md`, `command/35.md` don't exist and aren't referenced (pre-existing — don't "fix" casually, but don't add new broken links).
